...
<html>
<head>
<title>站内搜索-中国仪器仪表学会测量控制与仪器仪表工程师资格认证</title>
...
<table width="778"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0" style="WORD-BREAK: break-all">
      <tr>
        <td height="25" align="center" class="font14 gray">站内文章搜索</td>
      </tr>
      <tr>
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="3" align="center">
              <form name="myform" action="/search.php?action=search" method="get">
<input name="action" type="hidden" value="search">
          <tr align="center">
            <td height="30" align="right">搜索范围 </td>
            <td width="33%" align="left" colspan="3">
<input type="radio" class="radio" name="srchtype" value="0" checked> 文章标题
<input type="radio" class="radio" name="srchtype" value="1" > 文章内容
<input type="radio" class="radio" name="srchtype" value="2" > 作者 
<input type="radio" class="radio" name="srchtype" value="3" > 编辑
              </td>
          </tr>

          <tr align="center">
            <td width="15%" height="30" align="right">包含的关键字 </td>
            <td align="left"><input name="keywords" type="text" size="30" value=""> </td>
            <td colspan="2" align="left">多个关键词之间用空格隔开</td>
            </tr>

          <tr align="center">
            <td height="30" align="right">所属栏目  </td>
            <td width="28%" align="left">
            <select name="catid">
              <option value="0">所有栏目</option>
              <option value='1'  >新闻</option>
<option value='2'  >政策文件</option>
<option value='3'  >组织机构</option>
...
<option value='14'  >中国仪器仪表学会</option>
...
<option value="30" >1 个月前</option>
<option value="90" >3 个月前</option>
<option value="180" >6 个月前</option>
<option value="365" >1 年前</option>
</select>
<input type="radio" class="radio" name="before" value="0" checked> 之后
<input type="radio" class="radio" name="before" value="1" > 之前
</td>
            </tr>
          <tr align="center">
            <td height="30" align="right">文章性质</td>
            <td colspan="3" align="left">
<input type="checkbox" class="radio" name="elite" value="1" > 推荐
<input type="checkbox" class="radio" name="ontop" value="1" > 置顶
            </td>
            </tr>
          <tr align="center">
            <td height="30" align="right">排序方式</td>
            <td colspan="3" align="left">
<select name="ordertype">
<option value="1" >更新时间降序</option>
<option value="2" >更新时间升序</option>
<option value="3" >浏览次数降序</option>
<option value="4" >浏览次数升序</option>
</select>
            </td>
            </tr>
          <tr align="center">
            <td height="30" align="right">&nbsp;</td>
            <td colspan="3" align="left"><input type="submit" name="submit" value=" 搜索 "></td>
            </tr>
  </form>
        </table></td>
      </tr>
